...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['localeSessionRedirect', 'localizationRedirect', 'localeViewPath']], function () {
    ...
    Route::get(LaravelLocalization::transRoute('routes.chalet'), [PageController::class, 'cottage'])->name('chalet');
    Route::get(LaravelLocalization::transRoute('routes.attractions'), [PageController::class, 'cottage'])->name('attractions');
