<x-layouts.main>
    ...
    @section('description', __('privacy_policy.description'))
  


        @include('pages.privacy_policy.sections.hero')
        <main class="max-w-screen-xl mx-4 sm:mx-12 lg:mx-6 xl:mx-auto space-y-12 py-20">
            ...
            <div class="space-y-5">
                ...
                <p>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <a
                        href="http://chycowpotok.pl">chycowpotok.pl</a></p>
                <p>Operatorem serwisu oraz Administratorem danych osobowych jest: <strong>Chyców Potok 39
                    34-500 Zakopane</strong></p>
                <p>Adres kontaktowy poczty elektronicznej operatora: <a
                        href="domekpodubocom@gmail.com">domekpodubocom@gmail.com</a></p>
