<x-layouts.main>
    ...
    @section('title', 'Domek Pod Ubocom w Zakopanem - Blisko Natury i Centrum')
    @section('description',
        'Odkryj Regionalny Domek Pod Ubocom: komfortowy wypoczynek w Zakopanem, w otoczeniu łąk i
