    ...
    <div class="max-w-screen-xl mx-auto py-24 px-6 sm:px-12">
        ...
        <div class="grid lg:grid-cols-2  bg-bgWhite mt-16 shadow-lg md:opacity-0 image-animation">
            ...
            <div
                ...
                <p class="text-lg text-fontGray">Regionalny Domek Pod Ubocem oferuje dwa przytulne pokoje dwuosobowe,
                    salon z funkcjonalnym narożnikiem, dużą łazienkę z nowoczesnym wyposażeniem oraz dodatkową toaletę
                    na piętrze. Aneks kuchenny jest w pełni wyposażony, zapewniając komfort przygotowania posiłków. Jego
                    wyjątkowa lokalizacja zapewnia zarówno ciszę i spokój, jak i łatwy dostęp do centrum Zakopanego i
                    atrakcji turystycznych.</p>
                <div class="flex justify-between  items-center">
                    <a href=""
                        class="text-2xl text-fontGold hover:text-fontGray duration-300 font-light">Zarezerwuj</a>
                    <a href="{{ route('cottage') }}"
                        class="text-2xl text-fontGray hover:text-fontGold duration-300 font-light">Zobacz</a>
                </div>
            </div>
        </div>
    </div>
