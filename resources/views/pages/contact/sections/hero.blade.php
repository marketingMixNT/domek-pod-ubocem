<div
    class="flex flex-col justify-between items-center  px-4 sm:px-8 py-20 h-[70vh] w-full bg-[url('/public/assets/images/hero-contact--mobile.jpeg')] md:bg-[url('/public/assets/images/hero-contact--desktop.jpeg')] bg-cover bg-center bg-no-repeat bg-fixed bg-gray-300 bg-blend-multiply relative">
