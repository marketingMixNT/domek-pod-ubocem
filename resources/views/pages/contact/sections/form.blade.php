...
<form method="post" action="{{ route('contact_form') }}" id="contactForm" {{-- <form method="post" action="#" id="contactForm" --}}
    ...
    <button type="submit"  class="border py-4 px-10 uppercase text-sm font-semibold  duration-300 border-primary-400 bg-primary-400 text-fontLight hover:bg-secondary-200 mt-6">Wyślij</button>
