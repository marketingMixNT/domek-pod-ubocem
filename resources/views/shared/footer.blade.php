    ...
    <div class="max-w-screen-xl mx-auto space-y-10">
        ...
        <div
            ...
            <div class="flex items-center justify-center col-span-4 lg:col-span-1">
                <a href="{{route('home')}}">
                    <img src="{{ asset('/assets/logo--white.png') }}" alt="logo Domek Pod Ubocom"
                        class="w-48 lg:ml-16" /></a>
            </div>
            <!--TWO-->
            <div
                ...
                <div>
                    <h2 class="font-heading text-xl uppercase mb-2">
                       {{__('shared.footer.call_us')}}
                    </h2>
                    <a href="tel:+48606970787" class="font-thin font-heading hover:text-fontGold duration-300 text-lg">+48 606 970 787</a>
                </div>
                <div>
                    <h2 class="font-heading text-xl uppercase mb-2">
                        {{__('shared.footer.write_us')}}
                    </h2>
                    <a href="mailto:domekpodubocom@gmail.com"
                        class="font-thin font-heading hover:text-fontGold duration-300 text-lg">domekpodubocom@gmail.com</a>
                </div>
            </div>
            <!--THREE-->
            <div
                class="mx-4 md:mx-12 flex flex-col justify-center items-center text-center sm:justify-start sm:items-start sm:text-start">
                <h2 class="font-heading text-xl uppercase mb-2">{{__('shared.footer.address')}}</h2>
        ...
        <div class="max-w-screen-lg mx-4 sm:mx-24 xl:mx-auto">
            ...
            <ul class="flex justify-center items-center gap-8  py-4">
                <li>
                    <a href="{{route('privacy_policy')}}" class="hover:text-fontGold duration-300 text-base">{{__('shared.footer.privacy_policy')}}</a>
                </li>
